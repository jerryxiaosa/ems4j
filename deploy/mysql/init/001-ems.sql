...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE KEY `uk_energy_account_open_record_account_id` (`account_id`) USING BTREE,
...
(
    `id`               INT      NOT NULL AUTO_INCREMENT,
    `owner_type`       SMALLINT NOT NULL COMMENT '主体类型，0企业1个人',
    `owner_id`         INT      NOT NULL COMMENT '主体id',
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = UTF8MB4
  COLLATE = utf8mb4_unicode_ci COMMENT ='主体空间租赁关系';
...
(
    ...
    `device_no`           VARCHAR(50) CHARACTER SET UTF8MB4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '表号',
...
(
    ...
    KEY `idx_order_flow_create_time_account_balance_relation` (`create_time`, `account_id`, `balance_type`,
                                                               `balance_relation_id`)
) ENGINE = INNODB
  DEFAULT CHARSET = UTF8MB4
...
(
    ...
    `device_no`          VARCHAR(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '设备编号',
    ...
    KEY `idx_power_record_time_account_meter` (`record_time`, `account_id`, `meter_id`),
...
(
    ...
    KEY `idx_power_consume_account_time_meter` (`account_id`, `meter_consume_time`, `meter_id`)
) ENGINE = INNODB
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = UTF8MB4
  COLLATE = utf8mb4_unicode_ci
...
(
    ...
    KEY `idx_balance_consume_account_time_meter` (`account_id`, `meter_consume_time`, `meter_id`)
) ENGINE = INNODB
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = UTF8MB4
  COLLATE = utf8mb4_unicode_ci
...
(
    ...
    `is_deleted`    BIT(1)                                                        DEFAULT b'0',
    PRIMARY KEY (`id`) USING BTREE,
    KEY `idx_account_balance_consume_account_time` (`account_id`, `consume_time`)
) ENGINE = INNODB
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = UTF8MB4
  COLLATE = utf8mb4_unicode_ci
...
(
    ...
    `account_id`          INT                                                          NOT NULL COMMENT '账户id',
    `owner_id`            INT                                                          NOT NULL COMMENT '账户归属者id',
    `owner_type`          SMALLINT                                                     NOT NULL COMMENT '账户类型，0企业1个人',
    `owner_name`          VARCHAR(50) CHARACTER SET UTF8MB4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '企业/个人名称',
...
VALUES ('finance', 'service_rate', '默认服务费', '0.1', TRUE, FALSE, '2025-01-02 03:04:05'),
       ...
       ('plan', 'electric_price_time', '尖峰平谷深谷时间段配置',
        ...
        TRUE, FALSE, '2025-01-02 03:04:05'),
       ('plan', 'electric_step_price', '默认阶梯电价配置', '[]
', TRUE, FALSE, '2025-01-02 03:04:05'),
...
VALUES(1, '麒麟人工智能产业园', 0, '1', 1, null, 1, 0, 1, '管理员', '2026-01-26 15:14:33', 1, '管理员', '2026-01-27 11:00:32', 1);
