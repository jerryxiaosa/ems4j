...
class OwnerSpaceLeaseServiceImplIntegrationTest {
    ...
    void testRentSpaces_Success() {
        ...
        assertEquals(1, countOwnerSpaceRelation(OwnerTypeEnum.PERSONAL.getCode(), 1002, 1));
    }
    ...
    void testRentSpaces_Conflict() {
        ...
        assertEquals(0, countOwnerSpaceRelation(OwnerTypeEnum.PERSONAL.getCode(), 1002, 101));
    }
    ...
    void testUnrentSpaces_BlockedByMeter() {
        ...
        assertEquals(1, countOwnerSpaceRelation(OwnerTypeEnum.ENTERPRISE.getCode(), 1001, 101));
    }
    ...
    void testUnrentSpaces_Success() {
        ...
        assertEquals(0, countOwnerSpaceRelation(OwnerTypeEnum.PERSONAL.getCode(), 1002, 1));
    }

    private Integer countOwnerSpaceRelation(Integer ownerType, Integer ownerId, Integer spaceId) {
