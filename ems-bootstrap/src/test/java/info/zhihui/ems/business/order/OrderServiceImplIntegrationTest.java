...
import info.zhihui.ems.business.order.dto.creation.*;
import info.zhihui.ems.business.order.dto.thirdparty.wx.WxPayConfig;
import info.zhihui.ems.business.order.entity.*;
...
import info.zhihui.ems.business.order.repository.OrderDetailTerminationRepository;
...
import info.zhihui.ems.business.order.service.thirdparty.wx.sdk.WxMiniProgramPaySdk;
...
class OrderServiceImplIntegrationTest {
    ...
    void getDetail_ShouldReturnOrderBo_WhenOrderExists() {
        ...
        OrderBo result = orderService.getOrderBasic(orderSn);
    ...
    void getDetail_ShouldThrowNotFound_WhenOrderMissing() {
        assertThatThrownBy(() -> orderService.getOrderBasic("NOT-EXIST"))
    ...
    void getDetail_ShouldThrowNotFound_WhenOrderDeleted() {
        ...
        assertThatThrownBy(() -> orderService.getOrderBasic(orderSn))
                .isInstanceOf(NotFoundException.class)
                .hasMessageContaining("订单信息不存在");
    }
    ...
    void createOrder_ShouldCreateOrderSuccessfully_WhenWxMiniProgramPayment() {
        ...
        // 验证订单已保存到数据库
        OrderBo savedOrder = orderService.getOrderBasic(result.getOrderSn());
    ...
    void close_ShouldCloseOrderSuccessfully_WhenOrderExists() {
        ...
        // Then - 验证订单状态已更新为关闭
        OrderBo closedOrder = orderService.getOrderBasic(orderSn);
    ...
    void close_ShouldReturnEarly_WhenOrderAlreadyClosed() {
        ...
        OrderBo order = orderService.getOrderBasic(orderSn);
