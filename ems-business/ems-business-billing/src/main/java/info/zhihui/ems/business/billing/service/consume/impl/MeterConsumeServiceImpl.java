package info.zhihui.ems.business.billing.service.consume.impl;
...
import info.zhihui.ems.business.billing.qo.ElectricPowerConsumeRecordQo;
import info.zhihui.ems.business.billing.repository.ElectricMeterBalanceConsumeRecordRepository;
...
import info.zhihui.ems.business.billing.repository.ElectricMeterPowerRelationRepository;
...
import info.zhihui.ems.business.billing.service.consume.MeterCorrectionService;
...
public class MeterConsumeServiceImpl implements MeterConsumeService, MeterCorrectionService {
    ...
    private ElectricMeterPowerRecordEntity buildMeterPowerRecordEntity(ElectricMeterPowerRecordDto dto) {
        return new ElectricMeterPowerRecordEntity()
                ...
                .setDeviceNo(dto.getElectricMeterDetailDto().getDeviceNo())
    ...
    public void correctByAmount(@NotNull @Valid CorrectMeterAmountDto correctMeterAmountDto) {
        ...
        ElectricMeterBalanceConsumeRecordEntity record = new ElectricMeterBalanceConsumeRecordEntity()
                ...
                .setDeviceNo(correctMeterAmountDto.getDeviceNo())
    ...
    private MeterBillingDetailDto convertToMeterBillingDetailDto(ElectricMeterBalanceConsumeRecordEntity balanceConsumeRecord,
        ...
        return new MeterBillingDetailDto()
                ...
                .setDeviceNo(balanceConsumeRecord.getDeviceNo())
