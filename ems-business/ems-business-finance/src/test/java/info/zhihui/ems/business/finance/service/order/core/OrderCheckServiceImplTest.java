...
class OrderCheckServiceImplTest {
    ...
    void testCompletePendingOrdersInLast7Days_Success() {
        ...
        when(orderQueryService.findOrders(any(OrderQueryDto.class))).thenReturn(pendingOrders);

        // When
        assertDoesNotThrow(() -> orderCheckService.completePendingOrdersInLast7Days());

        // Then
        verify(orderQueryService).findOrders(any(OrderQueryDto.class));
    ...
    void testCompletePendingOrdersInLast7Days_EmptyOrders() {
        // Given
        when(orderQueryService.findOrders(any(OrderQueryDto.class))).thenReturn(Collections.emptyList());
    ...
    void testCompletePendingOrdersInLast7Days_NullOrders() {
        // Given
        when(orderQueryService.findOrders(any(OrderQueryDto.class))).thenReturn(null);
    ...
    void testCompletePendingOrdersInLast7Days_QueryServiceException() {
        // Given
        when(orderQueryService.findOrders(any(OrderQueryDto.class)))
    ...
    void testCompletePendingOrdersInLast7Days_VerifyQueryParameters() {
        ...
        // Then
        verify(orderQueryService).findOrders(argThat(queryDto -> {
