...
class OwnerSpaceLeaseServiceImplTest {
    ...
    void testRentSpaces_LockFailed() {
        ...
        verify(ownerSpaceRelationRepository, never()).insert(any(Collection.class));
    }
    ...
    void testRentSpaces_Success() {
        ...
        when(ownerSpaceRelationRepository.findListByOwnerAndSpaceIds(argThat(queryQo ->
                queryQo != null
                ...
                new OwnerSpaceRelationEntity().setOwnerType(OwnerTypeEnum.ENTERPRISE.getCode()).setOwnerId(1001).setSpaceId(101)
        ));
        ...
        ArgumentCaptor<Collection<OwnerSpaceRelationEntity>> captor = ArgumentCaptor.forClass(Collection.class);
        verify(ownerSpaceRelationRepository).insert(captor.capture());
        List<OwnerSpaceRelationEntity> insertList = captor.getValue().stream().toList();
    ...
    void testRentSpaces_Conflict() {
        ...
        when(ownerSpaceRelationRepository.findListByOwnerAndSpaceIds(argThat(queryQo ->
                ...
                new OwnerSpaceRelationEntity().setOwnerType(OwnerTypeEnum.PERSONAL.getCode()).setOwnerId(2).setSpaceId(101)
        ));
    ...
    void testUnrentSpaces_Success() {
        ...
        when(ownerSpaceRelationRepository.findListByOwnerAndSpaceIds(argThat(queryQo ->
                ...
                new OwnerSpaceRelationEntity().setOwnerType(OwnerTypeEnum.ENTERPRISE.getCode()).setOwnerId(1001).setSpaceId(101),
                new OwnerSpaceRelationEntity().setOwnerType(OwnerTypeEnum.ENTERPRISE.getCode()).setOwnerId(1001).setSpaceId(102)
        ));
        ...
        verify(ownerSpaceRelationRepository).deleteByOwnerAndSpaceIds(eq(OwnerTypeEnum.ENTERPRISE.getCode()), eq(1001), any());
        verify(lock).unlock();
    }
    ...
    void testUnrentSpaces_BlockedByMeter() {
        ...
        verify(ownerSpaceRelationRepository, never()).deleteByOwnerAndSpaceIds(any(), any(), any());
        verify(lock).unlock();
    }
}
