...
public class DeviceCommandSetCt implements DeviceCommandExecutor {

    private final DeviceModuleContext deviceModuleContext;

    @Override
    public CommandTypeEnum getCommandType() {
        return CommandTypeEnum.ENERGY_ELECTRIC_CT;
    }

    @Override
    public void execute(DeviceCommandRecordBo commandRecordBo) {
        log.info("开始执行命令：设置CT变比");
        ...
        energyService.setElectricCt(dto);
    }
}