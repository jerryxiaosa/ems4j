 ...
 */
@Component
public class SfereCutOffTranslator extends AbstractSfereCommandTranslator {

    private static final byte[] CUT_OFF_COMMAND = new byte[]{0x00, 0x02};
    ...
    protected ModbusRtuRequest buildRequest(DeviceCommand command) {
        ...
        return buildWrite(mapping, slaveAddress, CUT_OFF_COMMAND);
    }
