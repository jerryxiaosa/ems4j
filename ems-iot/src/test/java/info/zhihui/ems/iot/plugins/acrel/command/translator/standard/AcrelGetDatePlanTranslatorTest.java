...
class AcrelGetDatePlanTranslatorTest {
    ...
    void parseResponse_whenPayloadValid_shouldReturnItems() {
        AcrelGetDatePlanTranslator translator = new AcrelGetDatePlanTranslator();
        ...
        Assertions.assertEquals("3", first.getDailyPlanId());
        Assertions.assertEquals(MonthDay.of(4, 5), second.getDate());
        Assertions.assertEquals("6", second.getDailyPlanId());
    }
