...
class TimeSyncPacketDefinitionTest {
    ...
    void testTimeSyncDefinition_DelegatesToParserAndHandler() {
        ...
        Mockito.when(parser.command()).thenReturn(AcrelPacketKeySupport.commandKey(Acrel4gCommandConstants.TIME_SYNC));
        Mockito.when(handler.command()).thenReturn(AcrelPacketKeySupport.commandKey(Acrel4gCommandConstants.TIME_SYNC));
        ...
        Assertions.assertEquals(AcrelPacketKeySupport.commandKey(Acrel4gCommandConstants.TIME_SYNC), definition.command());
