...
class SfereGetHighEnergyTranslatorTest {

    @Test
    void type_shouldReturnGetHighEnergy() {
        SfereGetHighEnergyTranslator translator = new SfereGetHighEnergyTranslator();
    ...
    void toRequest_WithValidCommand_ShouldBuildReadRequest() {
        ...
        Assertions.assertEquals(0x008D, request.getStartRegister());
