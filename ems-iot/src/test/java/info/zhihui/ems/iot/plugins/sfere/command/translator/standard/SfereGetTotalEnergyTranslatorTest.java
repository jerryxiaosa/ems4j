...
class SfereGetTotalEnergyTranslatorTest {

    @Test
    void type_shouldReturnGetTotalEnergy() {
        SfereGetTotalEnergyTranslator translator = new SfereGetTotalEnergyTranslator();
    ...
    void toRequest_WithValidCommand_ShouldBuildReadRequest() {
        ...
        Assertions.assertEquals(0x0073, request.getStartRegister());
