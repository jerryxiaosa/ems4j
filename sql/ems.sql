...
(
    ...
    `ct`                DECIMAL(20, 8)                                                        DEFAULT NULL COMMENT 'ct变比，可为null',
    `create_user`       INT UNSIGNED                                                          DEFAULT NULL,
    `create_user_name`  VARCHAR(50) CHARACTER SET UTF8MB4 COLLATE utf8mb4_unicode_ci          DEFAULT NULL,
    `create_time`       DATETIME                                                              DEFAULT NULL,
    `update_user`       INT UNSIGNED                                                          DEFAULT NULL,
...
(
    ...
    `space_id`          INT                                                            NOT NULL COMMENT '设备所在空间id',
    `space_name`        VARCHAR(100) CHARACTER SET UTF8MB4 COLLATE utf8mb4_unicode_ci  NOT NULL COMMENT '设备所在空间名称',
    `account_id`        INT                                                                     DEFAULT NULL COMMENT '账户id',
    ...
    `execute_times`     SMALLINT                                                                DEFAULT NULL COMMENT '运行次数',
